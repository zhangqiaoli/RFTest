...
uint8_t rx_addr1[ADDRESS_WIDTH] = {0};
uint8_t rx_addr2[ADDRESS_WIDTH] = {0};
uint8_t rx_addr3[ADDRESS_WIDTH] = {0};
uint8_t tx_addr[ADDRESS_WIDTH] = {0};
uint8_t tx_addr1[ADDRESS_WIDTH] = {0};
uint8_t tx_addr2[ADDRESS_WIDTH] = {0};
uint8_t tx_addr3[ADDRESS_WIDTH] = {0};
...
void RF24L01_setup(uint8_t channel, uint8_t boardcast) {
  ...
  *((uint8_t *)&RF_SETUP) = 0;
  ...
  RF_SETUP.LNA_HCURR = 0x00;
  uint8_t setup = 0x26;
  //RF24L01_write_register(RF24L01_reg_RF_SETUP, ((uint8_t *)&RF_SETUP), 1);
  RF24L01_write_register(RF24L01_reg_RF_SETUP, &setup, 1);
  ...
  *((uint8_t *)&SETUP_RETR) = 0;
  ...
  SETUP_RETR.ARC = 0x0f;
  uint8_t retr = 0x5f;
  RF24L01_write_register(RF24L01_reg_SETUP_RETR, &retr, 1);  
