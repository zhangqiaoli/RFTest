...
//uint64_t writeaddr = (uint64_t)0xA1A1A1A1E1LL;
//uint64_t writeaddr1 = (uint64_t)0xA1A1A1A1E1LL;
//uint64_t writeaddr2 = (uint64_t)0xC7C7C7C7E1LL;
//uint64_t writeaddr3 = (uint64_t)0xF0F0F0F0E1LL;
uint64_t readaddr = (uint64_t)0xF0F0F0F0D2LL;
//uint64_t readaddr1 = (uint64_t)0xA1A1A1A1D2LL;
//uint64_t readaddr2 = (uint64_t)0xC7C7C7C7D2LL;
      ...
      if ( role == 0 )
      {
        ...
        if( radio.available()){
         ...
         /*if(pipenum == 1)
         {
           ...
           Serial.print(F("pipe 1"));          
         }
         else if(pipenum == 2 )
         {
           radio.openWritingPipe(readaddr2);
           Serial.print(F("pipe 2"));
         }else if(pipenum == 3 )
         {
           radio.openWritingPipe(readaddr3);
           Serial.print(F("pipe 3"));
         }*/
